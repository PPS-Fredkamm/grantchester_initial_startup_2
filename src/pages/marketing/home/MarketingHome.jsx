      ...
      <section className="story-section">
        <Container className="container-wide">
          <div className="section-header">
            <h2>Our Story</h2>
            <p>
              We create community and transform lives through world-class
              programs, premium facilities, and curated travel experiences. Our
              leadership team brings decades of experience across wellness,
          ...
          <Row className="align-items-center g-4">
            ...
            <Col lg={5}>
              <div className="story-copy">
                ...
                <p>
                  From daily programming to destination events, we deliver a
                  cohesive brand experience focused on wellness, connection, and
                  growth.
                </p>
          ...
          <Row className="g-3">
            <Col md={4}>
              <Card className="feature-card h-100">
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    Daily clinics, leagues, socials, and private training for
                    all levels.
                  </Card.Text>
                </Card.Body>
              </Card>
            ...
            <Col md={4}>
              <Card className="feature-card h-100">
                <Card.Img
                  variant="top"
                  src="/src/assets/images/for-universities.jpg"
                />
                <Card.Body>
                  <Card.Title>Events & Trips</Card.Title>
                  <Card.Text>
                    Signature events and luxury travel experiences across the
                    globe.
                  </Card.Text>
                </Card.Body>
              </Card>
            ...
            <Col md={4}>
              <Card className="feature-card h-100">
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    Holistic fitness and recovery to support performance and
                    lifestyle.
                  </Card.Text>
                </Card.Body>
              </Card>
        ...
        <Container className="container-narrow">
          <Card className="membership-card">
            <Card.Body>
              ...
              <Card.Text>
                Unlock priority access, member pricing, and exclusive
                experiences.
              </Card.Text>
              <div>
          ...
          <Row className="g-3">
            <Col md={4}>
              <Card className="news-card h-100">
                ...
                <Card.Body>
                  <Card.Title as="h5">
                    Designing Elevated Member Experiences
                  </Card.Title>
                  <Card.Text>
                    How we craft thoughtful touch points that feel premium and
                    personal.
                  </Card.Text>
                </Card.Body>
              </Card>
            ...
            <Col md={4}>
              <Card className="news-card h-100">
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    Integrating recovery and fitness to support a joyful
                    lifestyle.
                  </Card.Text>
                </Card.Body>
              </Card>
