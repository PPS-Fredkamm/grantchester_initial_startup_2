...
const plans = [
  ...
  },
  {
    title: 'Enterprise',
    price: 'Contact us',
    features: ['Custom integrations', 'Dedicated success manager', '24/7 Support'],
  },
];
  ...
  return (
    <>
      <Row>
        {plans.map((plan) => (
          <Col key={plan.title} md={4} sm={12} className="mb-4">
            <Card className={`h-100 shadow-sm ${plan.title === currentPlan ? 'border-primary' : ''}`}>
              <Card.Body>
                ...
                <div className="d-flex justify-content-end mt-3">
                  {plan.title === currentPlan ? (
                    ...
                    <Button variant="primary" onClick={() => handleSwitchClick(plan.title)}>
      ...
      <Modal show={showModal} onHide={handleCancel} centered>
        ...
        <Modal.Body>
          Are you sure you want to switch to the <strong>{selectedPlan}</strong> plan?
        </Modal.Body>
        <Modal.Footer>
