          ...
          <Accordion.Collapse eventKey="0">
            <Card.Body>
              ...
              <p>
                ...
                <br />
                Alumni-founded, venture-backed, or private companies preparing
                for IPOs, acquisitions, or other liquidity events.
              </p>
            </Card.Body>
          </Accordion.Collapse>
        </Card>
        ...
        <Card>
          ...
          <Accordion.Collapse eventKey="1">
            <Card.Body>
              ...
              <p>
                <strong>
                  Do universities need to hold the private shares?
                </strong>
                <br />
              ...
              <p>
                ...
                <br />
                Common or preferred equity, RSUs, and options may all be
                eligible depending on corporate structure.
              </p>
        ...
        <Card>
          ...
          <Accordion.Collapse eventKey="2">
            <Card.Body>
              <p>
                <strong>
                  What if our university has never accepted private equity
                  before?
                </strong>
                <br />
                We provide tools, documentation, and expert guidance to help
                your institution accept and manage these gifts securely.
              </p>
          ...
          <Accordion.Collapse eventKey="3">
            <Card.Body>
              ...
              <p>
                ...
                <br />
                Shares may be held long-term, and we help structure agreements
                to manage expectations and options for liquidity.
              </p>
            </Card.Body>
          </Accordion.Collapse>
        </Card>
          ...
          <Accordion.Collapse eventKey="4">
            <Card.Body>
              <p>
                ...
                <br />
                Contact us to schedule a demo or create a free account. We'll
                walk you through onboarding and legal readiness.
              </p>

              <p>
                <strong>Can we refer an alumnus or company?</strong>
                <br />
                Absolutely. We’ll help you reach out, present the opportunity,
                and handle onboarding with sensitivity.
              </p>
